...
hello_text = '''Привет! Ты попал к самому легендарному продавцу в Rc индустрии @kiffirua 🌫 для того что бы сделать заказ выберите город 🌃
✨✨✨
...
city_text = '''Трип-репорты, описание и фото товара, правила работы и на Форуме:
🌟 Оператор - @kiffirua
🌃 Чат - @smokekiff
Форум - https://goo.gl/HpRiTL
➖➖➖➖➖➖➖➖➖➖
...
thanks_text = '''Ваша оплата принята, клад будет скинут как только бот проверит оплату, эта процедура проходит каждые 10 секунд.
Помощь - @Kiffirua'''
